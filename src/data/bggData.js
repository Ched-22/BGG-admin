...
export const BGG_DATA = (() => {
  ...
  const tasks = [
    {
      ...
      orcamento: { valor: 6200, status: "Aprovado", fatura: "FAT-00829", metodo: "Cartão de Crédito", deposito: 1860, saldo: 4340 },
      anexos: [
    ...
    },
    {
      ...
      tecnicoStatus: "—",
      tecnicoNotas: "",
      orcamento: { valor: 4280, status: "Pendente", fatura: "—", metodo: "—", deposito: 0, saldo: 4280 },
    ...
    },
    {
      ...
      tecnicoStatus: "—",
      tecnicoNotas: "",
      orcamento: { valor: 1680, status: "Aprovado", fatura: "FAT-00828", metodo: "Pix", deposito: 504, saldo: 1176 },
      anexos: [],
      qa: { status: "—", notas: "", fotos: [], concluidoEm: "" },
    ...
    },
    {
      ...
      tecnicoStatus: "—",
      tecnicoNotas: "",
      orcamento: { valor: 7950, status: "Aprovado", fatura: "FAT-00824", metodo: "Cartão de Crédito", deposito: 2385, saldo: 5565 },
    ...
    },
    {
      ...
      orcamento: { valor: 12400, status: "Aprovado", fatura: "FAT-00811", metodo: "Cartão de Crédito", deposito: 3720, saldo: 8680 },
    ...
    },
    {
      ...
      tecnicoNotas: "",
      orcamento: { valor: 1980, status: "Aprovado", fatura: "FAT-00821", metodo: "Pix", deposito: 594, saldo: 1386 },
      anexos: [],
      qa: { status: "—", notas: "", fotos: [], concluidoEm: "" },
    ...
    },
    {
      ...
      tecnicoStatus: "—",
      tecnicoNotas: "",
      orcamento: { valor: 2380, status: "Pendente", fatura: "—", metodo: "—", deposito: 0, saldo: 2380 },
      anexos: [],
      qa: { status: "—", notas: "", fotos: [], concluidoEm: "" },
    ...
    },
    {
      ...
      tecnicoStatus: "Confirmado",
      tecnicoNotas: "",
      orcamento: { valor: 1450, status: "Aprovado", fatura: "FAT-00815", metodo: "Cartão de Crédito", deposito: 435, saldo: 1015 },
      anexos: [],
      qa: { status: "—", notas: "", fotos: [], concluidoEm: "" },
      agendaPreferencial: "Tardes",
      log: [],
    },
    {
      ...
      tecnicoStatus: "—",
      tecnicoNotas: "",
      orcamento: { valor: 2840, status: "Cancelado", fatura: "—", metodo: "—", deposito: 0, saldo: 0 },
      anexos: [],
      qa: { status: "—", notas: "", fotos: [], concluidoEm: "" },
      agendaPreferencial: "—",
      log: [
  ...
  // ---------- Alerts ----------
  const alerts = [
    { kind: "danger", title: "Pagamento com falha", desc: "TR-2829 — Cliente 22 · R$ 1.480,00", when: "há 32 min" },
    { kind: "success", title: "Pagamento recebido", desc: "TR-2832 — Cliente 04 · R$ 3.200,00", when: "há 1 h" },
